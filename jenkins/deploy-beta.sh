...
echo "sudo docker-compose -p "$JOB_NAME-beta" -f docker-compose-beta.yml rm --force -v";
sudo docker-compose -p "$JOB_NAME-beta" -f docker-compose-beta.yml rm --force -v
echo "sudo docker-compose -p "$JOB_NAME-beta" -f docker-compose-beta.yml up -d --force-recreate";
