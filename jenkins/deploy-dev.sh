...
echo "sudo docker-compose --no-color -p "$JOB_NAME-dev" -f docker-compose-dev.yml stop";
sudo docker-compose --no-color -p "$JOB_NAME-dev" -f docker-compose-dev.yml stop
